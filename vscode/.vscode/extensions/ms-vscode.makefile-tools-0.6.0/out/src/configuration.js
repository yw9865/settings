...
function updateOptionalFeaturesWithWorkspace() {
    ...
    let features = workspaceConfiguration.get("panel.visibility") || undefined;
    if (features) {
...
function readCompileCommandsPath() {
    let workspaceConfiguration = vscode.workspace.getConfiguration("makefile");
    compileCommandsPath = workspaceConfiguration.get("compileCommandsPath");
...
function getCommandForConfiguration(configuration) {
    ...
    let makefileUsed = (makefileConfiguration === null || makefileConfiguration === void 0 ? void 0 : makefileConfiguration.makefilePath) ? util.resolvePathToRoot(makefileConfiguration === null || makefileConfiguration === void 0 ? void 0 : makefileConfiguration.makefilePath) : makefilePath;
    if (makefileUsed) {
    ...
    if (!buildLogContent) {
        ...
        const makeNotFoundStr = localize(0, null, "Make");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vscode.workspace.onDidChangeConfiguration((e) => __awaiter(this, void 0, void 0, function* () {
            if (vscode.workspace.workspaceFolders &&
                ...
                let updatedCompileCommandsPath = workspaceConfiguration.get(subKey);
                ...
                updatedSettingsSubkeys.forEach(subKey => {
                    ...
                    try {
                        ...
                        telemetryProperties = telemetry.analyzeSettings(settingObj, key, util.thisExtensionPackage().contributes.configuration.properties[key], false, telemetryProperties);
                    }
                    catch (e) {
